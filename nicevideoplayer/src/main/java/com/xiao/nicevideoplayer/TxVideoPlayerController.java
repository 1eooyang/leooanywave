...
public class TxVideoPlayerController
    ...
    public void showProgress(boolean isShow){
        ...
        if (isShow) {
            ...
            mRestartPause.setVisibility(VISIBLE);
            ...
            mDuration.setVisibility(INVISIBLE);
        }
    ...
    private void init() {
        ...
        mVol = (ImageView) findViewById(R.id.vol);
...
//                }
                ...
                mNiceVideoPlayer.restart(lastposition);
                break;
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            ...
            if (mNiceVideoPlayer.getVolume()==0) {
                ...
                mVol.setImageResource(R.drawable.live_icon_detail_highvol);
            }
