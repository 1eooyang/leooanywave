...
import com.anywave.quanbo.activity.SplashActivity;
import com.anywave.quanbo.adapter.BusAdapter;
import com.anywave.quanbo.event.OnOff;
import com.anywave.quanbo.wifi.WifiConnAdmin;
...
//    public static Map<Integer,Boolean> currentDetailMap;
    ...
    public static volatile boolean IsWifiModel = true;//not
...
//        wifi.connect(WifiConnAdmin.WifiCipherType.WIFICIPHER_NOPASS);
    ...
    public void uncaughtException(Thread t, Throwable e) {
        try {
            // 创建日志文件
            String logPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/error_log_quanbo.txt";
            System.out.println("leo uncaughtException : "+ logPath);
            ...
            e.printStackTrace(printStream); // 将出错日志，打印至流
